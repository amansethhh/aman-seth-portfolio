...
const LiveProjectButton = ({ label = 'Live Project', className = '', href }: LiveProjectButtonProps) => {
  ...
  if (href) {
    return (
      <a href={href} target="_blank" rel="noopener noreferrer" className={`inline-block ${baseClasses}`}>
        {label}
      </a>
    )
  }
